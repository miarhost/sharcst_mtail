...
set :linked_files, %w{config/database.yml config/master.key .env docker-compose.yml Dockerfile Gemfile Gemfile.lock docker/nginx/nginx.conf docker/html/index.html newrelic.yml docker/newrelic-infra/newrelic-infra.yml}
