namespace :one_time_tasks do
  ...
  task create_infos: :environment do
    ActiveRecord::Base.transaction do
      UploadsInfo.create!([
                            { user_id: 1, upload_id: 1, number_of_seeds: 290, protocol: 'http', name: 'First test Uploads Info',
                            ...
                            { user_id: 1, upload_id: 1, number_of_seeds: 23, protocol: 'http', name: 'Info Upload 2',
